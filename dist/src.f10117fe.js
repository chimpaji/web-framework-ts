...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/model/Attributes.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function Attributes(data) {
    ...
    this.set = function (update) {
      Object.assign(_this.data, update); //take secound object to overwrite 1
    };
...
"use strict"; //all event tied to user

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Eventing = void 0;
var USER_ENDPOINT = 'http://localhost:3000/users';
...
},{}],"src/model/Model.ts":[function(require,module,exports) {
"use strict";
...
var Model = /*#__PURE__*/function () {
  function Model(attributes, events, sync) {
    ...
    this.events = events;
    this.sync = sync;
    this.on = this.events.on; // get on() {
    // 	return this.events.on;
    // }

    this.trigger = this.events.trigger; // get trigger() {
    // 	return this.events.trigger;
    // }

    this.get = this.attributes.get; // get get() {
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/model/ApiSync.ts":[function(require,module,exports) {
"use strict";
...
},{"axios":"node_modules/axios/index.js"}],"src/model/Collection.ts":[function(require,module,exports) {
"use strict";
...
},{"axios":"node_modules/axios/index.js","./Eventing":"src/model/Eventing.ts"}],"src/model/User.ts":[function(require,module,exports) {
"use strict"; // --Store date
...
var User = /*#__PURE__*/function (_Model_1$Model) {
  ...
  _createClass(User, [{
    ...
    value: function buildUserCollection() {
      return new Collection_1.Collection('http://localhost:3000/users', User.buildUser);
    }
  }]);
...
exports.User = User;
},{"./Attributes":"src/model/Attributes.ts","./Eventing":"src/model/Eventing.ts","./Model":"src/model/Model.ts","./ApiSync":"src/model/ApiSync.ts","./Collection":"src/model/Collection.ts"}],"src/views/View.ts":[function(require,module,exports) {
"use strict";
...
var View = /*#__PURE__*/function () {
    ...
    this.bindEvents = function (fragment) {
      ...
      var _loop = function _loop(eventKey) {
        ...
        fragment.querySelectorAll(selector).forEach(function (ele) {
          return ele.addEventListener(eventName, eventsMap[eventKey]);
        });
      };
  ...
  _createClass(View, [{
    ...
    value: function render() {
      ...
      var template = document.createElement('template'); //insert strign inside it to turn it into html

      template.innerHTML = this.template(); //bindEvents to all target

      this.bindEvents(template.content); //append that new html to the target
...
var UserForm = /*#__PURE__*/function (_View_1$View) {
  ...
  function UserForm() {
    ...
    _this.onChangeNameClick = function () {
      var input = _this.parent.querySelector('#name');
  ...
  _createClass(UserForm, [{
    ...
    value: function template() {
      return "\n\t\t<div>\n\t\t\t<input id=\"name\" type=\"text\"  placeholder=".concat(this.model.get('name'), " />\n\t\t\t<button id=\"change-name\">Change name</button>\n\t\t\t<br>\n\t\t\t<button id=\"set-age\">Set random age</button>\n\t\t</div>\n        ");
    }
  }, {
    key: "onButtonClick",
...
},{"./model/User":"src/model/User.ts","./views/UserForm":"src/views/UserForm.ts"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
